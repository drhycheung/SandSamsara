...
In every being's heart, **greed and fear** shadow each other, tearing at all they do. Greed draws them toward lush greenery and the water's edge: the greedier the heart, the more urgent its stride toward verdant shade — daring to scale steep slopes or leap from cliffs to reach it sooner; and when two covetous hearts eye the same patch of green, rivalry boils into shoving and open combat — blows exchanged, neither yielding, until on rare occasion one falls dead on the spot. Fear makes them recoil from fire and flee molten rock: the more timid the nature, the farther it senses danger and the faster it runs, trampling and jostling its companions in blind panic. The tug-of-war between greed and fear is the whole truth behind every pursuit and every flight in this world — grasping at what cannot be held, fleeing what might be lost; both are attachment, nothing more.

Nor is death ever the end. Whether consumed by flame or magma, drowned in water, or slain in combat with their own kind, at that very instant the wheel of rebirth turns: elsewhere in the world a new soul kindles at once, wreathed in a faint jade birth-light with motes of dust spiralling upward — reincarnated, remembering nothing. Thus the number of beings here never diminishes: the departed are reborn immediately; birth and death follow each other without pause, the very image of the word "samsara".
